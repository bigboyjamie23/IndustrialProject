		...
		<ul style="padding:0;margin-left:0px;text-indent: 0em;">
			 <li style="list-style-type:none;margin-left:10px;"> New Journals
			     <ul style="list-style-type: square">
				   <li style="margin-left: -10px;margin-top: 4px;"> <a href="$indexphp?action=AddJournal" title="Add a New Journal">Create new Journal</a> &nbsp; <br> <br></li>
			     </ul>
			 </li>
			 <li style="list-style-type:none;margin-left:10px;"> Find Journal
			    <ul style="list-style-type: square">
			       <form action="$indexphp?action=EditJournal" method="post" name="EditJournalForm" style="border: 0px none; padding-top: 0px; padding-bottom: 0px;margin-top: 0px;">
